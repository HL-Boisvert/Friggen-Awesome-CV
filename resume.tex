...
\vskip 0.1in
\header{Henri-Louis}{Boisvert}% Your name

\email{not-real-email@gmail.com}  % Keep your email out of public repos to protect it from spammers
\homepage{boisvert.netlify.app}
\github{HL-Boisvert}
\linkedin{henri-louis-boisvert}
%-------------------------------------------------------------------------------
%	SIDEBAR SECTION
%-------------------------------------------------------------------------------
